...
Abrir la carpeta con el proyecto en la terminal 
Ejecutar el comando docker compose up 
Abrir en el navegador (cualquiera): http://localhost:5173/ 
Una vez estando dentro de la API, se necesita ingresar correo y contraseña, para esto es necesario usar alguno de los ingresados en los inserts de la base de datos. Todos tienen como contraseña: contraseña_segura y el mail varía dependiendo del usuario, pero para ejemplos de cada rol: 
