        ...
        <div className="min-h-screen flex flex-col">
            ...
            <main className="flex-1">
                <div className="mx-auto max-w-7xl px-4 py-6">
                    ...
                    <div className="mb-6">
                        <div className="inline-flex gap-2 rounded-2xl bg-slate-100 p-1">
                            {tabs.map((t) => (
                                <button
                                    key={t.key}
                                    ...
                                    className={[
                                        ...
                                        tab === t.key
                                            ...
                                            : "bg-transparent text-slate-600 hover:bg-white/70 hover:text-blue-700",
                                    ].join(" ")}
                                >
                                    {t.label}
                                </button>
                    ...
                    {tab === "HACER" && (
                        <BuildingsGrid onReservaCreada={triggerReload} />
                    )}
                        ...
                        <div className="grid gap-3">
                            {organizo.map((r) => (
                                <ReservationCard
                                    ...
                                    onView={() => openDetail(r)}
                                    onInvite={() =>
                                        setInvite({ open: true, id: r.id_reserva })
                                    }
                                />
                            ))}
                            {organizo.length === 0 && (
